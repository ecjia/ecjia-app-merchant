...
class admin_store_setting extends ecjia_admin {
	public function __construct() {
        ...
        RC_Script::enqueue_script('qq_map', 'https://map.qq.com/api/js?v=2.exp&key='.ecjia::config('map_qq_key'));
	...
	public function update() {
        ...
        if (!empty($merchant)) {
            ...
            return $this->showmessage('编辑成功', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('merchant/admin_store_setting/edit', array('store_id' => $store_id))));
        }
	}
}
