            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal" name="theForm" action="{$form_action}"  method="post" enctype="multipart/form-data" data-toggle='from'>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-2">{t}店铺小程序二维码：{/t}</label>
                            <div class="col-lg-10">
                                {if $data.store_weapp_qrcode}
                                <div class="fileupload fileupload-{if $data.store_weapp_qrcode}exists{else}new{/if}" data-provides="fileupload">
                                    <div class="fileupload-{if $data.store_weapp_qrcode}exists{else}new{/if} thumbnail fileupload-store-weapp-qrcode f_l">
                                        <img src="{$data.store_weapp_qrcode}" alt="店铺二维码" style="width:150px; height:150px;"/>
                                    </div>
                                    <div class="help-block f_l" style="width: 700px;margin-left: 10px;">
