...
class merchant_merchant_menu_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        ...
        $submenus = array(
            ...
            ecjia_merchant::make_admin_menu('05_merchant_template', __('店铺模版'), RC_Uri::url('merchant/merchant/template'), 5)->add_purview('merchant_manage')->add_icon('fa-navicon'), 
        		
       		ecjia_merchant::make_admin_menu('06_merchant_printer', __('小票打印设置'), RC_Uri::url('printer/mh_print/init'), 6)->add_purview('printer_manage')->add_icon('fa-gears'),
        );
